...
export class ExportDatatableComponent {
    ...
    exportTable(type: string) {
        ...
        if (type == 'csv') {
            ...
            rowhtml +=
                '<style>body {font-family:Arial; color:#c80c22;}p{text-align:center;font-size:18px;font-weight:bold;margin:15px;}table{ border-collapse: collapse; border-spacing: 0; }th,td{font-size:12px;text-align:left;padding: 4px;}th{padding:8px 4px;}tr:nth-child(2n-1){background:#f7f7f7; }</style>';
            rowhtml += '</tbody></table>';
