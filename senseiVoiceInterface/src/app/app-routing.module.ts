...
const routes: Routes = [
  ...
  // Dashboard sécurisé
  {
    ...
    children: [
      ...
      { path: 'generate-with-selected-voice/:voice_id/:voice_name/:voice_photo/:voice_gender/:voice_age/:voice_category/:voice_language/:voice_preview_url', component: GenerationComponent },
