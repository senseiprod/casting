...
@Component({
  selector: "app-generation-with-speaker",
  templateUrl: "./generation-with-speaker.component.html",
  styleUrls: ["./generation-with-speaker.component.css"],
})
export class GenerationWithSpeakerComponent implements OnInit {
  languages = [
  ...
  getVoiceRouteParams(voice: any): any[] {
    if (voice.language === "darija") {
      return [
        ...
        voice.age || voice.ageZone || "Non défini",
      ...
      return [
        ...
        voice.gender || "Non défini",
        voice.age || "Non défini",
        voice.category || "Non classé",
        voice.language || "Non défini",
