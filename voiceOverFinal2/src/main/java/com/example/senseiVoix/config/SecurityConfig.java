                ...
                http
                                ...
                                .authorizeHttpRequests(req -> req.requestMatchers(WHITE_LIST_URL)
                                                ...
                                                .requestMatchers("/api/actions/create", "/api/actions/validate/{uuid}",
                                                                ...
                                                                "/api/payments/stripe/{clientId}",
                                                                "/api/payments",
                                                                "/api/payments/completed",
                                                                "/api/payments/**",
                                                                // PaypalController endpoints
                                                                "/payment/create",
                                                                "/payment/success",
                                                                "/payment/cancel",
                                                                "/payment/error",
                                                                "/payment/payout",
                                                                "/payment/**",
                                                                // PlayHtController endpoints
                                                                "/api/playht/synthesize",
                                                                "/api/playht/synthesize/advanced",
                                                                "/api/playht/cloned-voices",
                                                                "/api/playht/voices",
                                                                "/api/playht/clone-voice-from-file",
                                                                "/api/playht/clone-voice/url",
                                                                "/api/playht/clone-voice/{voice_id}",
                                                                "/api/playht/**",
