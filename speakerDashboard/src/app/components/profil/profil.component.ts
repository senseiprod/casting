...
import { SpeakerResponse, SpeakerService } from 'src/app/services/speaker.service';
import { ChangePasswordRequest, UtilisateurRequest, UtilisateurService } from 'src/app/services/utilisateur.service';
...
export class ProfilComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.authService.getUserConnect().subscribe((response)=>{
      ...
      this.loadUserPhoto();
      this.speakerService.getSpeakerByUuid(response.uuid).subscribe({
        next: (client) => {
          if (client) {
